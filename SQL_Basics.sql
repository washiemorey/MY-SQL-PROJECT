...
select count(Employee_Id) as "Total Entries" from employeedemographics;  #Count function
...
on A.Employee_ID = B.EmpployeeId;  

select * from employeedemographics                #Left join/left outer join
left outer join employeesalary
on employeedemographics.Employee_ID = employeesalary.EmpployeeId;
...
change column EmpployeeId EmployeeId int;
...
#HR   #Adding 10% Salary
#Regional Manager  #Addin 12% salary
...
#..........Having Clause.......................................................................
select B.Jobtitle,count(B.Jobtitle)               #Count of empoyees in each department 
...
select B.Jobtitle,avg(B.Salary) as "Average Salary"   #Average salary of eaach department 
from employeedemographics as A                        #Then selecting average greater than 45000
inner join employeesalary as B
on A.Employee_ID  = B.EmployeeId
group by Jobtitle
...
#Updating/Deleting data in data........................................................................
...
sum(Salary) over (partition by Jobtitle) as "Total Salary per Tittlr",
...
create procedure Table3(in title varchar(50))        #Creating procedure to get Employees by 
